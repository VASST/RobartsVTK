  ...
  vtkInformationVector* outputVector)
{
  ...
  int GaussWidth[3] =
  {
    static_cast<int>(this->GaussianDevs[0]* this->GaussianDevs[0] * 4.0),
    static_cast<int>(this->GaussianDevs[1]* this->GaussianDevs[1] * 4.0),
    static_cast<int>(this->GaussianDevs[2]* this->GaussianDevs[2] * 4.0)
  };
  this->ReserveGPU();
