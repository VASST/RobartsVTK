...
=========================================================================*/
// .NAME vtkImageMIManipulator - Returns the normalized mutual information
// of 2 images.
// .SECTION Description
...
#define __vtkImageMIManipulator_h
...
class VTKROBARTSREGISTRATION_EXPORT vtkImageMIManipulator : public vtkObject
{
public:
  static vtkImageMIManipulator *New();
  vtkTypeMacro(vtkImageMIManipulator,vtkObject);
  ...
  // Description:
  // Set/get the extent to calculate the MI over.
