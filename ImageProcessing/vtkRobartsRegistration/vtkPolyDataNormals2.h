/*=========================================================================
  ...
  Module:    $RCSfile: vtkPolyDataNormals2.h,v $
...
private:
  vtkPolyDataNormals2(const vtkPolyDataNormals2&);  // Not implemented.
  void operator=(const vtkPolyDataNormals2&);  // Not implemented.
};
