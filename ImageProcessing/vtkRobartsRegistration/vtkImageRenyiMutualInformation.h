...
class VTKROBARTSREGISTRATION_EXPORT vtkImageRenyiMutualInformation : public vtkThreadedImageAlgorithm
{
public:
...
#else
  vtkTypeMacro(vtkImageRenyiMutualInformation, vtkThreadedImageAlgorithm);
#endif
