/*=========================================================================
  ...
  Module:    $RCSfile: vtkImageNCCManipulator.h,v $
  Language:  C++
...
=========================================================================*/
// .NAME vtkImageNCCManipulator - Returns the absolute difference of 2 images.
// .SECTION Description
// vtkImageNCCManipulator calculates the absolute difference of 2 images.
...
// that both inputs are of the same size, and that you want the absolute
// difference to be 1E300, if image 1 is translated outside of image 2.

#ifndef __vtkImageNCCManipulator_h
#define __vtkImageNCCManipulator_h
...
class VTKROBARTSREGISTRATION_EXPORT vtkImageNCCManipulator : public vtkObject
{
public:
  static vtkImageNCCManipulator *New();
  vtkTypeMacro(vtkImageNCCManipulator,vtkObject);
  ...
  // Description:
  // Set/get the extent to calculate the NCC over
