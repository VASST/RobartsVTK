...
void vtkPolyDataNormals2::Execute()
{
  int j;
  vtkIdType npts = 0;
  vtkIdType i;
...
//
void vtkPolyDataNormals2::TraverseAndOrder (void)
{
  vtkIdType p1, p2, i, k;
  int j, l;
...
//
void vtkPolyDataNormals2::MarkAndSplit (vtkIdType ptId)
{
  int i,j;
...
void vtkPolyDataNormals2::PrintSelf(ostream& os, vtkIndent indent)
{
