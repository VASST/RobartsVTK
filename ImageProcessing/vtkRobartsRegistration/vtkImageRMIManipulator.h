/*=========================================================================
  ...
  Module:    $RCSfile: vtkImageRMIManipulator.h,v $
  Language:  C++
...
=========================================================================*/
// .NAME vtkImageRMIManipulator - Returns the normalized mutual information
// of 2 images.
// .SECTION Description
// vtkImageRMIManipulator calculates the normalized mutual information of 2 images.
...
// that both inputs are of the same size, and that you want the RMI to be 0, 
// if image 1 is translated outside of image 2.

#ifndef __vtkImageRMIManipulator_h
#define __vtkImageRMIManipulator_h
...
class VTKROBARTSREGISTRATION_EXPORT vtkImageRMIManipulator : public vtkObject
{
public:
  static vtkImageRMIManipulator *New();
  vtkTypeMacro(vtkImageRMIManipulator,vtkObject);
  ...
  double BinWidth[2];
  vtkSetMacro(qValue, float);
  double qValue;

  // Description:
  // Set/get the extent to calculate the RMI over.
