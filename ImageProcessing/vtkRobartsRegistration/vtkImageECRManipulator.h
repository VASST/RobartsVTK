/*=========================================================================
  ...
  Module:    $RCSfile: vtkImageECRManipulator.h,v $
  Language:  C++
...
=========================================================================*/
// .NAME vtkImageECRManipulator - Returns the normalized mutual information
// of 2 images.
// .SECTION Description
// vtkImageECRManipulator calculates the normalized mutual information of 2 images.
...
// that both inputs are of the same size, and that you want the ECR to be 0, 
// if image 1 is translated outside of image 2.

#ifndef __vtkImageECRManipulator_h
#define __vtkImageECRManipulator_h
...
class VTKROBARTSREGISTRATION_EXPORT vtkImageECRManipulator : public vtkObject
{
public:
  static vtkImageECRManipulator *New();
  vtkTypeMacro(vtkImageECRManipulator,vtkObject);
  ...
  // Description:
  // Set/get the extent to calculate the ECR over.
