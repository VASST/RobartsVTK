...
//----------------------------------------------------------------------------
void vtkPowellMinimizer::GetScalarVariableBracket(const char *name, double range[2])
{
...
//----------------------------------------------------------------------------
void vtkPowellMinimizer::SetScalarVariableBracket(const char *name, const double range[2])
{
