/*=========================================================================
  ...
  Module:    $RCSfile: vtkImageNMIManipulator.cxx,v $
  Language:  C++
...
//----------------------------------------------------------------------------
vtkImageNMIManipulator* vtkImageNMIManipulator::New()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkImageNMIManipulator");
  if(ret)
  {
    return (vtkImageNMIManipulator*)ret;
  }
  // If the factory was unable to create the object, then create it here.
  return new vtkImageNMIManipulator;
}

//----------------------------------------------------------------------------
vtkImageNMIManipulator::vtkImageNMIManipulator()
{
  for (int i = 0; i <= 5; i++)
  {
    this->Extent[i] = 0;
...
//----------------------------------------------------------------------------
void vtkImageNMIManipulator::SetInput1(vtkImageData *input)
{
...
//----------------------------------------------------------------------------
void vtkImageNMIManipulator::SetInput2(vtkImageData *input)
{
  this->inData[1] = input;
}

//----------------------------------------------------------------------------
vtkImageData *vtkImageNMIManipulator::GetInput1()
{
  return this->inData[0];
}

//----------------------------------------------------------------------------
vtkImageData *vtkImageNMIManipulator::GetInput2()
{
  return this->inData[1];
}

//----------------------------------------------------------------------------
void vtkImageNMIManipulator::SetBinNumber(int numS, int numT)
{
...
//----------------------------------------------------------------------------
template <class T>
void vtkImageNMIManipulatorEntropyT(vtkImageNMIManipulator *self,
...
//----------------------------------------------------------------------------
void vtkImageNMIManipulator::SetExtent(int ext[6])
{
  void *inPtr;
...
//----------------------------------------------------------------------------
void vtkImageNMIManipulator::SetTranslation(double tran[3])
{
  double f[3];
...
//----------------------------------------------------------------------------
template <class T>
void vtkImageNMIManipulatorExecute(vtkImageNMIManipulator *self,
                                   T  *in1Ptr, T *in2Ptr,
                                   ...
                                   int loc000[3], int loc111[3], double count)
{
  ...
  // Calculate entropies and the NMI
...
//----------------------------------------------------------------------------
double vtkImageNMIManipulator::GetResult()
{
  // Check inputs.
...
//----------------------------------------------------------------------------
void vtkImageNMIManipulator::PrintSelf(ostream& os, vtkIndent indent)
{
