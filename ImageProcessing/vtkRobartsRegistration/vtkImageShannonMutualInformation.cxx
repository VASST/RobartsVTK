...
#else
void vtkImageShannonMutualInformation::SetInput1Data(vtkImageData *input)
{
...
#else
void vtkImageShannonMutualInformation::SetInput2Data(vtkImageData *input)
{
...
#else
void vtkImageShannonMutualInformation::SetStencilData(vtkImageStencilData *stencil)
{
...
{
  if ((numS > 256) || (numT > 256))
  {
    vtkErrorMacro(<< "Number of bins must be <= 256.");
  }
...
vtkImageData *vtkImageShannonMutualInformation::GetOutput()
{
  ...
  double temp = 0.0;
  vtkImageData *HistST = Superclass::GetOutput(0);
    ...
    int inExt[6], int id)
{
...
#else
  // If algorithm is re-written to accommodate vtk6 style pipeline
  //->Get(vtkStreamingDemandDrivenPipeline::WHOLE_EXTENT(), ext0)
  ...
  {
    vtkTemplateMacro(vtkImageShannonMutualInformationExecute(this,
