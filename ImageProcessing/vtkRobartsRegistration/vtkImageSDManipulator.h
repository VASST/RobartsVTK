/*=========================================================================
  ...
  Module:    $RCSfile: vtkImageSDManipulator.h,v $
  Language:  C++
...
=========================================================================*/
// .NAME vtkImageSDManipulator - Returns the square difference of 2 images.
// .SECTION Description
// vtkImageSDManipulator calculates the square difference of 2 images.
...
// that both inputs are of the same size, and that you want the square
// difference to be 1E300, if image 1 is translated outside of image 2.

#ifndef __vtkImageSDManipulator_h
#define __vtkImageSDManipulator_h
...
class VTKROBARTSREGISTRATION_EXPORT vtkImageSDManipulator : public vtkObject
{
public:
  static vtkImageSDManipulator *New();
  vtkTypeMacro(vtkImageSDManipulator,vtkObject);
  ...
  // Description:
  // Set/get the extent to calculate the SD over
