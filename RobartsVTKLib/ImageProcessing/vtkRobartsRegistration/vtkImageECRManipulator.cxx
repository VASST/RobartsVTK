/*=========================================================================
  ...
  Module:    $RCSfile: vtkImageECRManipulator.cxx,v $
  Language:  C++
...
=========================================================================*/
#include "vtkImageECRManipulator.h"
...
//----------------------------------------------------------------------------
vtkImageECRManipulator* vtkImageECRManipulator::New()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkImageECRManipulator");
  if(ret)
    {
    return (vtkImageECRManipulator*)ret;
    }
  // If the factory was unable to create the object, then create it here.
  return new vtkImageECRManipulator;
}

//----------------------------------------------------------------------------
vtkImageECRManipulator::vtkImageECRManipulator()
{
...
//----------------------------------------------------------------------------
vtkImageData *vtkImageECRManipulator::GetInput1()
{
  return this->inData[0];
}

//----------------------------------------------------------------------------
vtkImageData *vtkImageECRManipulator::GetInput2()
{
  return this->inData[1];
}

//----------------------------------------------------------------------------
void vtkImageECRManipulator::SetBinNumber(int numS, int numT)
{
...
//----------------------------------------------------------------------------
template <class T>
void vtkImageECRManipulatorEntropyT(vtkImageECRManipulator *self,
...
//----------------------------------------------------------------------------
void vtkImageECRManipulator::SetExtent(int ext[6])
{
  void *inPtr;
  ...
  switch (this->inData[1]->GetScalarType())
    {
      ...
      vtkTemplateMacro4(vtkImageECRManipulatorEntropyT,this, 
      (VTK_TT *)(inPtr), this->inc2, this->count);
#else
      vtkTemplateMacro(vtkImageECRManipulatorEntropyT(this, 
      (VTK_TT *)(inPtr), this->inc2, this->count));
#endif
    default:
...
//----------------------------------------------------------------------------
void vtkImageECRManipulator::SetTranslation(double tran[3])
{
  double f[3];
...
//----------------------------------------------------------------------------
template <class T>
void vtkImageECRManipulatorExecute(vtkImageECRManipulator *self,
           T  *in1Ptr, T *in2Ptr,
           ...
           int loc000[3], int loc111[3], double count)
{
  ...
  // Calculate entropies and the ECR
  ...
  if (entropyS + self->entropyT == 0)
    ...
    {
      self->Result = sqrt ( entropyST / ( self->entropyT + entropyS ) );
    }

}

//----------------------------------------------------------------------------
double vtkImageECRManipulator::GetResult()
{
  // Check inputs.
...
//----------------------------------------------------------------------------
void vtkImageECRManipulator::PrintSelf(ostream& os, vtkIndent indent)
{
