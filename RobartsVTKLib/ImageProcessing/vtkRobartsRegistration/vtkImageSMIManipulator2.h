/*=========================================================================
  ...
  Module:    $RCSfile: vtkImageSMIManipulator2.h,v $
  Language:  C++
...
=========================================================================*/
// .NAME vtkImageSMIManipulator2 - Returns the normalized mutual information
// of 2 images.
// .SECTION Description
...
#define __vtkImageSMIManipulator2_h
...
class VTKROBARTSREGISTRATION_EXPORT vtkImageSMIManipulator2 : public vtkObject
{
public:
  static vtkImageSMIManipulator2 *New();
  vtkTypeMacro(vtkImageSMIManipulator2,vtkObject);
  ...
  // Description:
  // Set/get the extent to calculate the SMI over.
