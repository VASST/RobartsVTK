...
class VTKROBARTSREGISTRATION_EXPORT vtkImageShannonMutualInformation : public vtkThreadedImageAlgorithm
{
public:
...
#else
  vtkTypeMacro(vtkImageShannonMutualInformation, vtkThreadedImageAlgorithm);
#endif
  ...
  // Description:
  // Override GetOutput to allow summing of histogram over threads.
