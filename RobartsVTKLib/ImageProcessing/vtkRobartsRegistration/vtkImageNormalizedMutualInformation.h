...
class VTKROBARTSREGISTRATION_EXPORT vtkImageNormalizedMutualInformation : public vtkThreadedImageAlgorithm
{
public:
...
#else
  vtkTypeMacro(vtkImageNormalizedMutualInformation,vtkThreadedImageAlgorithm);
#endif
