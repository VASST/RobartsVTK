/** @file CUDA_vtkCuda2DInExLogicVolumeMapper_renderAlgo.h
 *
...
#ifndef CUDA_vtkCuda2DInExLogicVolumeMapper_RENDERALGO_H
#define CUDA_vtkCuda2DInExLogicVolumeMapper_RENDERALGO_H
 ...
 *
 */
bool CUDA_vtkCuda2DInExLogicVolumeMapper_renderAlgo_loadImageInfo(const float* imageData, const cudaVolumeInformation& volumeInfo, const int index, cudaStream_t* stream);
