/*=========================================================================
  ...
  Module:    $RCSfile: vtkImageADManipulator.h,v $
  Language:  C++
...
=========================================================================*/
// .NAME vtkImageADManipulator - Returns the absolute difference of 2 images.
// .SECTION Description
// vtkImageADManipulator calculates the absolute difference of 2 images.
...
class VTK_EXPORT vtkImageADManipulator : public vtkObject
{
public:
  static vtkImageADManipulator *New();
  vtkTypeMacro(vtkImageADManipulator,vtkObject);
  ...
  // Description:
  // Set/get the extent to calculate the AD over
