/*=========================================================================
  ...
  Module:    $RCSfile: vtkImageSMIManipulator.h,v $
  Language:  C++
...
=========================================================================*/
// .NAME vtkImageSMIManipulator - Returns the normalized mutual information
// of 2 images.
// .SECTION Description
// vtkImageSMIManipulator calculates the normalized mutual information of 2 images.
...
class VTK_EXPORT vtkImageSMIManipulator : public vtkObject
{
public:
  static vtkImageSMIManipulator *New();
  vtkTypeMacro(vtkImageSMIManipulator,vtkObject);
