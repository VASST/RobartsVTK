/*=========================================================================
  ...
  Module:    $RCSfile: vtkImageResliceBSpline.cxx,v $
  Language:  C++
...
=========================================================================*/
#include "vtkImageResliceBSpline.h"
...
#endif
vtkStandardNewMacro(vtkImageResliceBSpline);
vtkCxxSetObjectMacro(vtkImageResliceBSpline, InformationInput, vtkImageData);
vtkCxxSetObjectMacro(vtkImageResliceBSpline,ResliceAxes,vtkMatrix4x4);
vtkCxxSetObjectMacro(vtkImageResliceBSpline,ResliceTransform,vtkAbstractTransform);
...
double vtkImageResliceBSpline::LookupTable[LookupTableSize][4];
...
//----------------------------------------------------------------------------
vtkImageResliceBSpline::vtkImageResliceBSpline()
{
...
//----------------------------------------------------------------------------
void vtkImageResliceBSpline::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkImageResliceBSpline::GetResliceAxesDirectionCosines(double xdircos[3],
                                                     double ydircos[3],
                                                     double zdircos[3])
{
  if (!this->ResliceAxes)
...
//----------------------------------------------------------------------------
void vtkImageResliceBSpline::SetResliceAxesOrigin(double x, double y, double z)
{
  if (!this->ResliceAxes)
    {
    // consistent registers/unregisters
...
//----------------------------------------------------------------------------
void vtkImageResliceBSpline::GetResliceAxesOrigin(double origin[3])
{
  if (!this->ResliceAxes)
    {
...
unsigned long int vtkImageResliceBSpline::GetMTime()
{
...
//----------------------------------------------------------------------------
void vtkImageResliceBSpline::ComputeInputUpdateExtents(vtkDataObject *output)
{
...
//----------------------------------------------------------------------------
void vtkImageResliceBSpline::GetAutoCroppedOutputBounds(vtkImageData *input,
                                                 double bounds[6])
{
  int i, j;
...
//----------------------------------------------------------------------------
void vtkImageResliceBSpline::ExecuteInformation()
{
...
//----------------------------------------------------------------------------
void vtkImageResliceBSpline::ExecuteInformation(vtkImageData *input,
                                         vtkImageData *output)
{
  int i,j;
  double inSpacing[3], inOrigin[3];
...
//                const T *background)
//
// where 'T' is any arithmetic type and 'F' is a double type
//
...
#define vtkTypeCaseMacro(expression) \
      case VTK_DOUBLE: { typedef double VTK_TT; expression; } \
        break; \
      case VTK_FLOAT: { typedef double VTK_TT; expression; } \
        break; \
...
inline void vtkResliceRound(double val, double& rnd)
{
  rnd = val;
}
...
// and scalar type
template<class F>
void vtkGetResliceInterpFunc(vtkImageResliceBSpline *self,
...
void vtkGetSetPixelsFunc(vtkImageResliceBSpline *self,
...
template <class T>
void vtkAllocBackgroundPixelT(vtkImageResliceBSpline *self,
...
void vtkAllocBackgroundPixel(vtkImageResliceBSpline *self, void **rval,
                             int numComponents)
{
...
void vtkFreeBackgroundPixel(vtkImageResliceBSpline *self, void **rval)
{
  switch (self->GetOutput()->GetScalarType())
    {
...
// in structure than vtkImageResliceBSplineOptimizedExecute.
void vtkImageResliceBSplineExecute(vtkImageResliceBSpline *self,
...
void vtkImageResliceBSpline::ThreadedExecute(vtkImageData *inData,
                                      ...
                                      int outExt[6], int id)
{
  ...
  vtkImageResliceBSplineExecute(this, inData, inPtr, outData, outPtr, outExt, id);
}
...
//----------------------------------------------------------------------------
template <class F>
void vtkResliceOptimizedComputeInputUpdateExtent(vtkImageResliceBSpline *self,
                                                 int inExt[6],
                                                 int outExt[6],
                                                 F newmat[4][4])
{
  ...
  for (i = 0; i < 8; i++)
    {
    // calculate transform using method in vtkImageResliceBSplineExecute
    idX = outExt[i%2];
    idY = outExt[2+(i/2)%2];
    idZ = outExt[4+(i/4)%2];
...
void vtkImageResliceBSpline::OptimizedComputeInputUpdateExtent(int inExt[6],
                                                        int outExt[6])
{
...
template <class F>
void vtkOptimizedExecute(vtkImageResliceBSpline *self,
                         vtkImageData *inData, void *inPtr,
                         vtkImageData *outData, void *outPtr,
...
template<class F>
void vtkGetResliceSummationFunc(vtkImageResliceBSpline *self,
...
//----------------------------------------------------------------------------
template <class F>
void vtkPermuteNearestTable(vtkImageResliceBSpline *self, const int outExt[6],
                            const int inExt[6], const int inInc[3],
...
//----------------------------------------------------------------------------
template <class F>
void vtkPermuteLinearTable(vtkImageResliceBSpline *self, const int outExt[6],
                           const int inExt[6], const int inInc[3],
...
//----------------------------------------------------------------------------
template <class F>
void vtkPermuteCubicTable(vtkImageResliceBSpline *self, const int outExt[6],
                          const int inExt[6], const int inInc[3],
                          int clipExt[6], int **traversal, F **constants,
                          int useNearestNeighbor[3], F newmat[4][4])
{
...
template <class F>
void vtkReslicePermuteExecute(vtkImageResliceBSpline *self,
                                     vtkImageData *inData, void *inPtr,
                                     vtkImageData *outData, void *outPtr,
                                     int outExt[6], int id, F newmat[4][4])
{
...
vtkMatrix4x4 *vtkImageResliceBSpline::GetIndexMatrix()
{
...
// It just executes a switch statement to call the correct function for
// the regions data types.
void vtkImageResliceBSpline::OptimizedThreadedExecute(vtkImageData *inData,
                                               vtkImageData *outData,
                                               int outExt[6], int id)
{
  int inExt[6];
