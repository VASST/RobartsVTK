...
char* qTransferFunctionDefinitionWidget::getHistogram(vtkImageData* image, float& retIntensity1Low, float& retIntensity1High, float& retIntensity2Low, float& retIntensity2High, bool setSize)
{
  //if we have no images to make histograms of, then leave
  if(image == 0 || image->GetNumberOfScalarComponents() != 2)
  {
    return 0;
  }
