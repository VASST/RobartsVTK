...
void HistogramHolderDefault::giveHistogramDimensions(float maxG, float minG, float maxI, float minI){
  histogram = true;
  minGradient = minG;
  maxGradient = maxG;
  maxIntensity = maxI;
...
void HistogramHolderDefault::setZoomSquare(float maxG, float minG, float maxI, float minI){
  hasZoomSquare = true;
...
void HistogramHolderDefault::setSize(unsigned int s){
