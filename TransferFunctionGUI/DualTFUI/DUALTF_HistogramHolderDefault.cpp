...
DUALTF_HistogramHolderDefault::DUALTF_HistogramHolderDefault(DUALTF_transferFunctionDefinitionWidget* parent, vtkCuda2DTransferFunction* f):
...
DUALTF_HistogramHolderDefault::~DUALTF_HistogramHolderDefault(){
}


void DUALTF_HistogramHolderDefault::setAutoUpdate(bool au){
	autoUpdate = au;
}

void DUALTF_HistogramHolderDefault::giveHistogramDimensions(float maxI1,float minI1, float maxI2, float minI2){
	histogram = true;
	maxIntensity1 = maxI1;
	minIntensity1 = minI1;
	maxIntensity2 = maxI2;
...
void DUALTF_HistogramHolderDefault::setZoomSquare(float maxI1,float minI1, float maxI2, float minI2){
	hasZoomSquare = true;
...
void DUALTF_HistogramHolderDefault::setObject(vtkCudaFunctionPolygon* object){
	this->object = object;
}

void DUALTF_HistogramHolderDefault::setSize(unsigned int s){
...
void DUALTF_HistogramHolderDefault::keyPressEvent(QKeyEvent* e){
	if(e->key() == Qt::Key::Key_Shift) shiftHeld = true;
	if(e->key() == Qt::Key::Key_Control) ctrlHeld = true;
}

void DUALTF_HistogramHolderDefault::keyReleaseEvent(QKeyEvent* e){
	if(e->key() == Qt::Key::Key_Shift) shiftHeld = false;
	if(e->key() == Qt::Key::Key_Control) ctrlHeld = false;
}

void DUALTF_HistogramHolderDefault::mousePressEvent(QMouseEvent* e){
...
void DUALTF_HistogramHolderDefault::mouseReleaseEvent(QMouseEvent* e){
	//if we do not have a histogram or object, this has no meaning
	if(!histogram) return;
...
void DUALTF_HistogramHolderDefault::mouseMoveEvent(QMouseEvent* e){
...
void DUALTF_HistogramHolderDefault::paintEvent( QPaintEvent * e){
	if(!histogram) return;
...
void DUALTF_HistogramHolderDefault::visualizeAllObjects(bool b){
	visAll = b;
}