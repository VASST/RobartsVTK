...
DUALTF_transferFunctionWindowWidget::DUALTF_transferFunctionWindowWidget(QWidget *parent) :
	transferFunctionWindowWidgetInterface(parent)
{
	...
	fmWidget = new fileManagementWidget( this );
	...
	function->Delete();
	tfWidget = new DUALTF_transferFunctionDefinitionWidget( this, mapper->GetFunction() );
	...
	function->Delete();
	ktfWidget = new DUALTF_transferFunctionDefinitionWidget( this, mapper->GetKeyholeFunction() );
	...
	segWidget = new DUALTF_segmentationWidget(this);
...
DUALTF_transferFunctionWindowWidget::~DUALTF_transferFunctionWindowWidget(){
...
void DUALTF_transferFunctionWindowWidget::UpdateScreen(){
	this->screen->repaint();
...
void DUALTF_transferFunctionWindowWidget::LoadedImageData(){
...
void DUALTF_transferFunctionWindowWidget::changeTab(){
...
void DUALTF_transferFunctionWindowWidget::keyPressEvent(QKeyEvent* e){
...
void DUALTF_transferFunctionWindowWidget::keyReleaseEvent(QKeyEvent* e){
