/*=========================================================================
  ...
  Module:    $RCSfile: vtkImageHackedPlaneWidget.h,v $
...
=========================================================================*/
// .NAME vtkImageHackedPlaneWidget - 3D widget for reslicing image data
// .SECTION Description
...
// vtkImageHackedPlaneWidget, like any 3D widget, will work with the current
// interactor style. That is, if vtkImageHackedPlaneWidget does not handle an
...
// vtkImageHackedPlaneWidget will terminate the processing of the event that it
// handles.
//
...
// "interactor") is pressed, the vtkImageHackedPlaneWidget will appear. (See
...
//
// The vtkImageHackedPlaneWidget has several methods that can be used in
...
class VTK_WIDGETS_EXPORT vtkImageHackedPlaneWidget : public vtkPolyDataSourceWidget
{
public:
  // Description:
  ...
  void SetInput(vtkDataSet* input, double* minMax = 0);
...
protected:
  ...
  vtkImageReslice      *ResliceG;
  vtkImageReslice      *ResliceB;
...
private:
  vtkImageHackedPlaneWidget(const vtkImageHackedPlaneWidget&);  //Not implemented
  void operator=(const vtkImageHackedPlaneWidget&);  //Not implemented
};
