...
shadingWidget::shadingWidget( transferFunctionWindowWidgetInterface* p ) :
  QWidget(p)
{
  parent = p;
  window = 0;
...
void shadingWidget::setStandardWidgets( vtkRenderWindow* w, vtkRenderer* r, vtkCudaVolumeMapper* c ){
  window = w;
  renderer = r;
  mapper = c;
...
void shadingWidget::changeShading(){
...
void shadingWidget::setCelShadingConstants(float d, float a, float b){
  mapper->SetCelShadingConstants(d,a,b);
}

void shadingWidget::setDistanceShadingConstants(float d, float a, float b){
