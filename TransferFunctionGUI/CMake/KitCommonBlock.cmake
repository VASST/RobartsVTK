...
IF(RobartsVTK_KITS)
  STRING(REGEX MATCH "${KIT}" already_have_kit ${RobartsVTK_KITS})
ELSE(RobartsVTK_KITS)
  SET(already_have_kit 0)
ENDIF(RobartsVTK_KITS)

IF(NOT already_have_kit)
  SET(RobartsVTK_KITS ${RobartsVTK_KITS} ${KIT}
    CACHE INTERNAL "RobartsVTK Kits" FORCE)
  
  SET(RobartsVTK_LIBRARIES ${RobartsVTK_LIBRARIES} vtk${KIT}
    CACHE INTERNAL "RobartsVTK libraries" FORCE)
  
  SET(RobartsVTK_INCLUDE_DIRS ${RobartsVTK_INCLUDE_DIRS} ${CMAKE_CURRENT_SOURCE_DIR} ${CMAKE_CURRENT_BINARY_DIR}
    CACHE INTERNAL "RobartsVTK libraries" FORCE)
