    ...
    int logUsed )
{
  ...
  if(outputRTable)
  {
    memset( (void*) outputRTable, 0.0f, sizeof(float) * sizeI * sizeG);
  }
  if(outputGTable)
  {
    memset( (void*) outputGTable, 0.0f, sizeof(float) * sizeI * sizeG);
  }
  if(outputBTable)
  {
    memset( (void*) outputBTable, 0.0f, sizeof(float) * sizeI * sizeG);
  }
  if(outputATable)
  {
    memset( (void*) outputATable, 0.0f, sizeof(float) * sizeI * sizeG);
  }
    ...
    int logUsed )
{
  ...
  if(outputDTable)
  {
    memset( (void*) outputDTable, 0.0f, sizeof(float) * sizeI * sizeG);
  }
  if(outputSTable)
  {
    memset( (void*) outputSTable, 0.0f, sizeof(float) * sizeI * sizeG);
  }
  if(outputPTable)
  {
    memset( (void*) outputPTable, 0.0f, sizeof(float) * sizeI * sizeG);
  }
...
vtkCudaFunctionObject* vtkCuda2DTransferFunction::GetFunctionObject(size_t index)
{
...
size_t vtkCuda2DTransferFunction::GetNumberOfFunctionObjects()
{
