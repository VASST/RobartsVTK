...
public:
  ...
  /**
   *  @brief Retrieves a given function object from the list of function objects by it's index
   ...
   */
  vtkCudaFunctionObject* GetFunctionObject(size_t index);

  /**
   *  @brief Retrieves the current number of function objects associated with the function
   */
  size_t GetNumberOfFunctionObjects();
